<form action="" method="post" id="registerForm">
    <div class="flex flex-col space-y-2">
        ...
        <input type="text" name="nom" id="nom" placeholder="Nom" class="bg-slate-200 p-2">
        <label for="password">Password</label>
        <input type="password" name="password" id="password" placeholder="Password" class="bg-slate-200 p-2">
        <label for="passwordConfirm">Confirm Password</label>
        <input type="password" name="passwordConfirm" id="passwordConfirm" placeholder="Confirm Password" class="bg-slate-200 p-2">
        <div id="errorMsg"></div>
